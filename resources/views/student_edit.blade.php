...
<div class="container">
    <div class="title">Student Update
        ...
        <a href="{{route('student_list')}}"
            class="btn btn-sm btn-success ms-2"><i class="fa fa-user" aria-hidden="true"></i> Student List</a>
    </div>
    ...
    <form id="student_update_form">
        ...
        <div class="user-details mt-4">
            <div class="input-box">
                ...
                <input type="text" name="student_name" id="student_name" value="{{$student->student_name}}" placeholder="Enter your name" required />
            </div>
            ...
            <div class="input-box">
                ...
                <textarea name="student_address" id="student_address" placeholder="Enter your address" required>{{$student->student_address}}</textarea>
            </div>
            <div class="input-box">
        ...
        <div class="button">
            <input type="button" id="student_update_submit" value="Register" />
        </div>
...
<script>
    $(document).ready(function() {
        $('#student_update_submit').on('click', function(e) {
            e.preventDefault();
            ...
            formData.append('student_profile', $('#student_profile')[0].files[0]); // For file upload
            formData.append('_token', $('input[name="_token"]').val());

            // Assuming your route includes the student ID
